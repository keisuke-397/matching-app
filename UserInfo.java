...
public class UserInfo implements Serializable{
	public static int MAX=100;	//イイネ数をやグループ数の保持する限界数。変えてもいい
	public int state=0;		//新規登録なら0,プロフ更新なら1

	public int studentNumber=1;	//学籍番号
	public String password="";
	public String name="国大太郎";		//ユーザ名。認証時は氏名として使う。
	//性別～サークルはClient.java内の配列で文字に変換する
	public int gender=2;	//性別
	public int grade=0;	//学年
	public int faculty=0;	//学部
	public int birth=0;	//出身
	public int circle=0;	//サークル
	public int[] bufStudentCard;		//学生証バフ
	public int[] bufMainPhoto;
	public int[] bufSubPhoto1;
	public int[] bufSubPhoto2;
	public int[] bufSubPhoto3;
	public int[] bufSubPhoto4;
	public String hobby="";	//趣味
	public int[] sendGood=new int[MAX];	//自分がイイネを送った相手の学籍番号
	public int[] receiveGood=new int[MAX];	//自分にイイネを送った相手の学籍番号
	public int[] matchedUser=new int[MAX];	//マッチングした相手の学籍番号
	public UUID[] joiningGroup=new UUID[MAX];		//参加しているグルの識別番号
	public UUID[] invitedGroup=new UUID[MAX];		//誘われているグルの識別番号
	public transient BufferedImage studentCard;		//学生証の写真
	public int isAuthentificated=0;		//0:認証されていない,1:認証された,2:認証されたが「認証されました画面」を見ていない
	public transient BufferedImage mainPhoto;	//メインの写真
	public transient BufferedImage[] subPhoto=new BufferedImage[4];		//サブの写真
	public String lineId="未登録";	//ラインID
	public boolean isPublic=true;		//プロフの非公開を希望するユーザはfalseに。falseだと検索に引っかからなくなる。


	public int widthOfStudentCard;
	public int heightOfStudentCard;
	public int widthOfMainPhoto;
	public int heightOfMainPhoto;
	public int[] widthOfSubPhoto=new int[4];
	public int[] heightOfSubPhoto=new int[4];
	;
